...
<template>
    <div class="flex flex-col justify-between h-full">
        <div>
            <h1 class="text-center text-3xl p-4 mt-4">Which is <span class="text-green-500">Tyson</span> cuter?</h1>
            ...
            <div class="flex flex-col sm:flex-row justify-evenly items-center m-2">
                ...
                <span class="text-2xl italic my-4 sm:my-0">
                    or
                </span>
                <Tyson class="sm:mt-0" :tyson="tysons.secondTyson" :disabled="pendingVote"
...
const { data: tysons } = await useAsyncData('tysons', () => $fetch(`${config.API_URL}/api/pair`, { params: { except: mostRecentlyVotedFor.value } })) as AsyncData<TysonResponse, Error>;
